...
const RootNavbar = () => {
    return (
      <div className="bg-[#1C4DB9] z-[999] fixed w-full p-3 flex item-center justify-between lg:px-20 md:px-10  ">
        <h2 className="text-white font-inter pt-2 lg:text-lg text-xs pr-3 md:pr-0">
