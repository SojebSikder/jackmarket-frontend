    ...
    return (
        <div className='lg:mt-0 mt-14'>
            ...
            <div className=" md:flex  gap-10 mt-10">
                ...
                {/* right side */}
                <div className="">
                    <h1 className='text-2xl  font-semibold  lg:w-96 '>3Bears Pocket Porridge Mohnige Banane 55g</h1>
                    <p className='text-lg mt-3'>€1.32 <del className='text-gray-500'>€1.89</del></p>
                    <p className='text-sm text-gray-500'>€24,00 / 1kg</p>
                    <div className='mt-7'><Button >{' Add Item '}</Button></div>
                </div>
            </div>
            {/* tabs */}
            <div className='mt-14 mb-32 '>
                <Tabs  style="underline" >
                    <Tabs.Item  title="Product Information">
                        This is <span className="font-medium text-gray-800 dark:text-white"> Porridge bars (oat-based muesli bars) with bananas and poppy seeds.</span>.
                    
                        Porridge redefined. Our pocket porridge combines the best of all worlds. Ready to eat like a bar and with all the benefits that you already know from our
                        porridge. Only the best ingredients and a fabulous taste with extra fruit! Now finally for on the go. Just tear open and enjoy.
                    </Tabs.Item>
