            ...
            <div className=' flex items-center justify-center  w-full  lg:mt-28 ' >
                <div className="  ">
                    ...
                    <div className='flex flex-col gap-3 mt-5'>
                        <Link href='/register' className=''><button className=" rounded p-2 px-4 font-semibold text-white bg-primary duration-300 active:scale-95 w-full"> Create account  </button></Link>
                        <Link href='/login' className=''><button className=" rounded p-2 px-4 font-semibold  bg-[#E9D7D8] text-primary duration-300 active:scale-95 w-full"> Login  </button></Link>
                    </div>
