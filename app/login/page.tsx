        ...
        <div>
            ...
            <div className=' flex items-center justify-center  w-full  lg:mt-20 ' >
                <div className=" lg:w-96 w-full  ">
                    ...
                    <p className='mb-2 text-gray-600'>To log in, please enter your details below.</p>
                        ...
                        <form action="" className="space-y-6 mt-4">
                            ...
                            {/* Sign in Button */}
                            <button className=" rounded p-2 px-4 font-semibold text-white bg-primary duration-300 active:scale-95 w-full"> Login  </button>
                        </form>
