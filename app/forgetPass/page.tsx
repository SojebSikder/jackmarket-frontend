        ...
        <div>
            ...
            <div className=' flex items-center justify-center  w-full  lg:mt-28 md:mt-10 p-10 ' >
                <div className="  ">
                    ...
                    <p className='mb-2'>Give us your email and we’ll send you <br/> instructions on how to reset your password</p>
                    ...
                    <Link href='/register' className=''><button className=" rounded p-2 px-4 font-semibold text-white bg-primary duration-300 active:scale-95 w-full"> Send instructions  </button></Link>
